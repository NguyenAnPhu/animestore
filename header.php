		...
		<ul class="container_top">
			...
			<?php
				if(!isset($_SESSION['my_name']) ){
					...
					echo '
					<li class="info_user"><span class="glyphicon icon-login " aria-hidden="true"></span><a href=""><span class="bx bxs-user" style="transform: translateY(1px);"></span>'.$_SESSION['my_name'].'</a>
						<ul class="user_menu">
	...
	<div class="container">
		...
		<div class="top_nav_right">
			<div class="cart box_1">
						<?php 
							if(isset($_SESSION['my_name']) && isset($_SESSION['my_pass']) && isset($_SESSION['cart'])){
