<?php 
     ...
     {
          function connect () {
               $con = mysqli_connect("localhost","admin","123","anime_db");
               if(!$con)
			{
			...
			if($n > 0 ) {
               ...
               while($row = mysqli_fetch_array($ketqua)){
					...
					if($txt_name == $user_name && $txt_pass == $password && $permission==1)
                         ...
                         }else if($txt_name == $user_name && $txt_pass == $password)
                         {     
                              $_SESSION['user_id'] = $user_id;
						$_SESSION['my_name'] = $txt_name;
						$_SESSION['my_pass'] = $txt_pass;
          ...
          function confirmLogin ($myname,$mypass){
			$link = $this->connect();
               $sql= "select * from user where name ='$myname' and password = '$mypass'";
			$ketqua = mysqli_query($link,$sql);
			$n = mysqli_num_rows($ketqua);
			if($n > 0 ) {
				while($row = mysqli_fetch_array($ketqua)){
               ...
               if($n > 0) {
                    ...
                    while($row = mysqli_fetch_array($result)){
                         ...
                         <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="margin-top:24px; visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
                                        ...
                                        <div class="desription " style = "display: flex ;">
                                             <h4>Shipping : </h4>
                         ...
                         <div class="bootstrap-tab animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
                              <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                                   <ul id="myTab" class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">desription</a></li>
                                   ...
                                   <div id="myTabContent" class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
                                             <h5>Product Brief desription</h5>
                                             <h4>'.$des.'</h4>
                                        </div>
